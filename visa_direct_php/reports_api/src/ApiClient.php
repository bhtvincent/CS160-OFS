...
class ApiClient
{
     ...
     */
    public function __construct(\rpt_100\Configuration $config = null)
    {
        if ($config === null) {
     ...
     *
     * @throws \rpt_100\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($path, $resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers, true)) {
            ...
            $postData = json_encode(\rpt_100\ObjectSerializer::sanitizeForSerialization($postData));
        }
