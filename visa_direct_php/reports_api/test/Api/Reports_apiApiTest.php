...
use \rpt_100\api\Reports_apiApi;

/**
 * Reports_apiApiTest Class Doc Comment
 *
 * @category Class
 * @package  rpt_100
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Reports_apiApiTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * Test case for getreportingApi
     *
     * .
     *
     */
    public function testGetreportingApi()
    {
        echo "\nMaking a call to GetreportingApi()\n";

        $api_instance = new Reports_apiApi;
        $result = $api_instance->GetreportingApi($this->addRandom('random'), $this->addRandom('random'), $this->addRandom('random'), $this->addRandom('random'), $this->addRandom('random'));
