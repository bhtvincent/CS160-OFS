...
```php
    require_once('/path/to/prod_6/rpt_100/autoload.php');
```
...
use \rpt_100\Configuration;
    ...
    //Set all the required parameters in the getreportingApi. Look at the documentation for further clarification.
...
------------ | ------------- | ------------- | -------------
*Reports_apiApi* | [**getreportingApi**](docs/Api/Reports_apiApi.md#getreportingapi) | **GET** /visadirect/reports/v1/transactiondata | 


## Documentation For Models

 - [ReportingApigetResponse](docs/Model/ReportingApigetResponse.md)
