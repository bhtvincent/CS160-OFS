...
class Funds_transferApi
{
     ...
     */
    public function postmultipullfunds($multipullfundspost_payload)
    {
        list($response) = $this->postmultipullfundsWithHttpInfo($multipullfundspost_payload);
        return $response;
    }
     ...
     */
    public function postmultipullfundsWithHttpInfo($multipullfundspost_payload)
    {
     ...
     */
    public function postmultipushfunds($multipushfundspost_payload)
    {
        list($response) = $this->postmultipushfundsWithHttpInfo($multipushfundspost_payload);
        return $response;
    }
     ...
     */
    public function postmultipushfundsWithHttpInfo($multipushfundspost_payload)
    {
