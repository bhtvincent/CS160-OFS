...
class PullfundspostPayload implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'pin_data' => '\ft_100\model\PinData',
        'sender_first_name' => 'string',
        'sender_city' => 'string',
        'fee_program_indicator' => 'string',
        'address_verification_data' => '\ft_100\model\AddressVerificationData',
        'sender_account_number' => 'string',
        'magnetic_stripe_data' => '\ft_100\model\MagneticStripeData',
        'acquiring_bin' => 'int',
    ...
    /**
     * Sets amount
     * @param float $amount The amount of the transaction, inclusive of all fees you assess for the transaction, including currency conversion fees. If the originator is populating the surcharge or foreignExchangeFeeTransaction field, they must be included in the amount field.
     * @return $this
     */
     ...
     * @param float $national_reimbursement_fee If present, this field should contain the IRF fees.
     * @return $this
     */
    ...
    /**
     * Sets pin_data
     * @param \ft_100\model\PinData $pin_data
     * @return $this
     */
     ...
     * @return \ft_100\model\AddressVerificationData
     */
     ...
     * @param \ft_100\model\AddressVerificationData $address_verification_data
     * @return $this
     */
     ...
     * @return \ft_100\model\MagneticStripeData
     */
     ...
     * @param \ft_100\model\MagneticStripeData $magnetic_stripe_data
     * @return $this
     */
     ...
     * @param string $cps_authorization_characteristics_indicator Request for CPS authorization. If present, a valid value is required. Spaces or special characters are not allowed.
     * @return $this
     */
