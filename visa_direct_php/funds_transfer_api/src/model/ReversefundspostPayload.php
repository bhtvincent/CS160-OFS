...
class ReversefundspostPayload implements ArrayAccess
{
     ...
     * @param float $foreign_exchange_fee_transaction When present, this field contains the sender's foreign exchange markup fee (markup above the wholesale or VisaNet exchange rate as assessed by the originator.Values in this field must be in the same currency and format as defined in the amount field(minimum value is 0).
     * @return $this
     */
