...
/**
 * MerchandiseReturnGetgetResponse Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     mvrf_100
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MerchandiseReturnGetgetResponse implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'merchandiseReturnGetgetResponse';
     ...
     * @param string $retrieval_reference_number This is a key data element for matching a message to others within a given transaction set.
     * @return $this
     */
    ...
    /**
     * Sets action_code
     * @param string $action_code It contains a code that defines the response to a request <br><br>Refer to <a href=\"/request_response_codes#action_code\"> Action Code </a>
     * @return $this
     */
