...
class MerchandiseReturnPostpostPayload implements ArrayAccess
{
     ...
     * @param string $recipient_primary_account_number Populate with Consumer PAN, as defined by mVisa specifications. This is the same PAN the consumer used in merchant payment.
     * @return $this
     */
     ...
     * @param string $transaction_fee_amt Prefix ‘C’ <br><br>Originators are required to populate convenience fee amount in this field to be returned, if presented in the original message
     * @return $this
     */
     ...
     * @param string $systems_trace_audit_number This must be the same value as in the original request.
     * @return $this
     */
     ...
     * @param string $transaction_identifier This value must match with the VisaNet reference number previously sent in the original merchant payment.
     * @return $this
     */
