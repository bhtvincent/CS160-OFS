...
/**
 * MerchandiseReturnPostpostResponse Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     mvrf_100
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MerchandiseReturnPostpostResponse implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'merchandiseReturnPostpostResponse';
    ...
    /**
     * Sets action_code
     * @param string $action_code It contains a code that defines the response to a request <br><br>Refer to <a href=\"/request_response_codes#action_code\">ActionCode</a>
     * @return $this
     */
