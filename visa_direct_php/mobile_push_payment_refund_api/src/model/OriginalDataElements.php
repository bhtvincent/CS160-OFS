...
class OriginalDataElements implements ArrayAccess
{
    ...
    /**
     * Sets acquiring_bin
     * @param int $acquiring_bin This field must match with the BIN previously sent in the original refund transaction.
     * @return $this
     */
    ...
    /**
     * Sets approval_code
     * @param string $approval_code This field, if present, must contain the approvalCode from the original refund transaction.
     * @return $this
     */
     ...
     * @param int $systems_trace_audit_number This field must contain with the systemsTraceAuditNumber previously sent in  the original refund transaction.
     * @return $this
     */
     ...
     * @param string $transmission_date_time This field must contain the transmissionDateTime from the original refund transaction.
     * @return $this
     */
