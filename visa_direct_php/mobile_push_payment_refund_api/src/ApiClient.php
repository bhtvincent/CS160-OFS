...
class ApiClient
{
     ...
     */
    public function __construct(\mvrf_100\Configuration $config = null)
    {
        if ($config === null) {
     ...
     *
     * @throws \mvrf_100\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($path, $resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers, true)) {
            ...
            $postData = json_encode(\mvrf_100\ObjectSerializer::sanitizeForSerialization($postData));
        }
