...
class WsApiTest extends \PHPUnit\Framework\TestCase
{
     ...
     *
     */
    public function testPostwatchlistinquiry()
    {
        echo "\nMaking a call to Postwatchlistinquiry()\n";

        $api_instance = new WsApi;
        $result = $api_instance->Postwatchlistinquiry($this->transformPayload('{"acquiringBin":"408999","address":{"city":"San Francisco","cardIssuerCountryCode":"USA"},"acquirerCountryCode":"840","name":"Mohammed Qasim","referenceNumber":"330000550000"}'), $this->transformPayload('{"acquiringBin":"408999","address":{"city":"San Francisco","cardIssuerCountryCode":"USA"},"acquirerCountryCode":"840","name":"Mohammed Qasim","referenceNumber":"330000550000"}'), $this->transformPayload('{"acquiringBin":"408999","address":{"city":"San Francisco","cardIssuerCountryCode":"USA"},"acquirerCountryCode":"840","name":"Mohammed Qasim","referenceNumber":"330000550000"}'), $this->transformPayload('{"acquiringBin":"408999","address":{"city":"San Francisco","cardIssuerCountryCode":"USA"},"acquirerCountryCode":"840","name":"Mohammed Qasim","referenceNumber":"330000550000"}'), $this->transformPayload('{"acquiringBin":"408999","address":{"city":"San Francisco","cardIssuerCountryCode":"USA"},"acquirerCountryCode":"840","name":"Mohammed Qasim","referenceNumber":"330000550000"}'));
