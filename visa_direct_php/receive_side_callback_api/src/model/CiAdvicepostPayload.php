...
/**
 * CiAdvicepostPayload Class Doc Comment
 *
 * @category    Class
 * @description Request body for Receive Cash-In Advice API
 * @package     rcvs_100
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CiAdvicepostPayload implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ciAdvicepostPayload';
     ...
     * @param string $originator_country_code A 3-digit ISO-4217 code that identifies the country of the originating BIN.<br>Refer to <a href=\"/request_response_codes#currency_codes\">ISO codes</a>.
     * @return $this
     */
