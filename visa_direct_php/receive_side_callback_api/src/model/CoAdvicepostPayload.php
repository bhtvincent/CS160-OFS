...
/**
 * CoAdvicepostPayload Class Doc Comment
 *
 * @category    Class
 * @description Request body for Receive Cash-Out Advice API
 * @package     rcvs_100
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CoAdvicepostPayload implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'coAdvicepostPayload';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['agent_country_code'] = isset($data['agent_country_code']) ? $data['agent_country_code'] : null;
        ...
        $this->container['enc_agent_pan'] = isset($data['enc_agent_pan']) ? $data['enc_agent_pan'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['enc_agent_pan'] === null) {
            $invalid_properties[] = "'enc_agent_pan' can't be null";
        }
    ...
    /**
     * Gets agent_country_code
     * @return string
     */
    public function getAgentCountryCode()
    {
        return $this->container['agent_country_code'];
    }

    /**
     * Sets agent_country_code
     * @param string $agent_country_code <b>Conditional</b>. Recipient may replace this field with 2-letter ISO 3166 country code of the agent, if different than the value provided by the originator. Visa settlement reports would contain the value provided by recipient. This field is to be sent as NULL if it is not populated.
     * @return $this
     */
    public function setAgentCountryCode($agent_country_code)
    {
        $this->container['agent_country_code'] = $agent_country_code;
    ...
    /**
     * Sets originator_bin
     * @param string $originator_bin This BIN number identifies the originator of Cash-Out payment transaction.
     * @return $this
     */
     ...
     * @param string $transaction_amount Transaction amount in agent on currency. In case the agent currency is not the same as the consumer currency, then originator will perform currency conversion before submitting the transaction.
     * @return $this
     */
