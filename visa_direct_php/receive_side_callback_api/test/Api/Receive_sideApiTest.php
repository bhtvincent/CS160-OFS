...
use \rcvs_100\api\Receive_sideApi;

/**
 * Receive_sideApiTest Class Doc Comment
 *
 * @category Class
 * @package  rcvs_100
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Receive_sideApiTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * Test case for postcashIn
     *
     * .
     *
     */
    public function testPostcashIn()
    {
        echo "\nMaking a call to PostcashIn()\n";

        $api_instance = new Receive_sideApi;
        $result = $api_instance->PostcashIn($this->transformPayload('null'));
    ...
    /**
     * Test case for postcashIn_0
     *
     * .
     *
     */
    public function testPostcashIn0()
    {
        echo "\nMaking a call to PostcashIn0()\n";

        $api_instance = new Receive_sideApi;
        $result = $api_instance->PostcashIn0($this->transformPayload('null'));
    ...
    /**
     * Test case for postciAdvice
     *
     * .
     *
     */
    public function testPostciAdvice()
    {
        echo "\nMaking a call to PostciAdvice()\n";

        $api_instance = new Receive_sideApi;
        $result = $api_instance->PostciAdvice($this->transformPayload('null'));
    ...
    /**
     * Test case for postcoAdvice
     *
     * .
     *
     */
    public function testPostcoAdvice()
    {
        echo "\nMaking a call to PostcoAdvice()\n";

        $api_instance = new Receive_sideApi;
        $result = $api_instance->PostcoAdvice($this->transformPayload('null'));
    ...
    /**
     * Test case for postreceiveP2M
     *
     * .
     *
     */
    public function testPostreceiveP2M()
    {
        echo "\nMaking a call to PostreceiveP2M()\n";

        $api_instance = new Receive_sideApi;
        $result = $api_instance->PostreceiveP2M($this->transformPayload('null'));
    ...
    /**
     * Test case for postreceiveP2MAdvice
     *
     * .
     *
     */
    public function testPostreceiveP2MAdvice()
    {
        echo "\nMaking a call to PostreceiveP2MAdvice()\n";

        $api_instance = new Receive_sideApi;
        $result = $api_instance->PostreceiveP2MAdvice($this->transformPayload('null'));
