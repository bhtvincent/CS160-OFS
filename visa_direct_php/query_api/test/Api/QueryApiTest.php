 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class QueryApiTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * Test case for gettransactionQuery
     *
     * .
     *
     */
    public function testGettransactionQuery()
    {
        ...
        $api_instance = new QueryApi;
        $result = $api_instance->GettransactionQuery($this->addRandom('random'), $this->addRandom('random'), $this->addRandom('random'), $this->addRandom('random'), $this->addRandom('random'), $this->addRandom('random'), $this->addRandom('random'), $this->addRandom('random'), $this->addRandom('random'), $this->addRandom('random'));
