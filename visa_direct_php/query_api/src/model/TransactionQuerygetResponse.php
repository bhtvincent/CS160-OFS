...
class TransactionQuerygetResponse implements ArrayAccess
{
    ...
    protected static $attributeMap = [
        ...
        'authorization_source_code' => 'authorizationSourceCode',
    ...
    protected static $setters = [
        ...
        'authorization_source_code' => 'setAuthorizationSourceCode',
    ...
    protected static $getters = [
        ...
        'authorization_source_code' => 'getAuthorizationSourceCode',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['authorization_source_code'] = isset($data['authorization_source_code']) ? $data['authorization_source_code'] : null;
    ...
    /**
     * Gets authorization_source_code
     * @return string
     */
    public function getAuthorizationSourceCode()
    {
        return $this->container['authorization_source_code'];
    }

    /**
     * Sets authorization_source_code
     * @param string $authorization_source_code STIP (Stand-in Parameters) Advice Code. <br/> Valid Values include* <br/> 1 - STIP, ATR Timed Out <br/> 2 - STIP, Below LCS Limit <br/> 3 - STIP, Issuer in SI Mode <br/> 4 - STIP, Issuer Unavailable <br/> 6 - STIP, FOR 3RD PARTY PROCR
     * @return $this
     */
    public function setAuthorizationSourceCode($authorization_source_code)
    {
        $this->container['authorization_source_code'] = $authorization_source_code;
    ...
    /**
     * Sets action_code
     * @param string $action_code The results of the transaction request <br/> Refer to <a href='/request_response_codes#action_code'>actionCode</a><br/> <b>Note:</b> The VisaNet Response Code for the transaction
     * @return $this
     */
    ...
    /**
     * Sets response_code
     * @param string $response_code The source for the response; typically, either the recipient issuer or a Visa system. <br/> Refer to <a href='/request_response_codes#response_code'>responseCode</a><br/> <b>Note:</b> The VisaNet Response Source for the transaction
     * @return $this
     */
