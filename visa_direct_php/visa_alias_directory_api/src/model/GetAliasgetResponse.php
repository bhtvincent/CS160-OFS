...
/**
 * GetAliasgetResponse Class Doc Comment
 *
 * @category    Class
 * @description Alias Get Response
 * @package     alias_100
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GetAliasgetResponse implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetAliasgetResponse';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['recipient_first_name'] === null) {
            $invalid_properties[] = "'recipient_first_name' can't be null";
        }
        if ($this->container['recipient_primary_account_number'] === null) {
            $invalid_properties[] = "'recipient_primary_account_number' can't be null";
        }
        if ($this->container['consent_date_time'] === null) {
            $invalid_properties[] = "'consent_date_time' can't be null";
        }
        ...
        if ($this->container['recipient_last_name'] === null) {
            $invalid_properties[] = "'recipient_last_name' can't be null";
        }
        ...
        if ($this->container['alias_type'] === null) {
            $invalid_properties[] = "'alias_type' can't be null";
        }
     ...
     * @param string $consent_date_time Date & time when consumer has provided their consent to Issuer about the use of their personal personal data for VAD service. Format: YYYY-MM-DD hh:nn:ss. <br>It is in Coordinated Universal Time (UTC).
     * @return $this
     */
     ...
     * @param string $status_change_date_time The date and time when the status of an alias is changed.  It is in Coordinated Universal Time (UTC).<br><b>Note:</b> This attribute is only applicable to selective markets. Please contact Visa's representative for details.
     * @return $this
     */
    ...
    /**
     * Sets card_type
     * @param string $card_type Card type description. Reference to Field 62.23—Product ID of available card products. e.g. Visa Classic, Visa Platinum
     * @return $this
     */
    ...
    /**
     * Sets status
     * @param string $status The status of an alias.  For consumer alias, this value can be 'INACTIVE', 'ACTIVE', or 'DISABLED'.  For merchant/agent alias, this value can be 'ACTIVE' or 'DISABLED'.<br><b>Note:</b> This attribute is only applicable to selective markets.  Please contact Visa's representative for details.
     * @return $this
     */
    ...
    /**
     * Sets country
     * @param string $country Consumer’s country code as defined by ISO 3166.
     * @return $this
     */
    ...
    /**
     * Sets issuer_name
     * @param string $issuer_name This is the Issuer name of recipient’s card
     * @return $this
     */
    ...
    /**
     * Sets alias_type
     * @param string $alias_type “01” – Phone number <br>“02” – email address
     * @return $this
     */
