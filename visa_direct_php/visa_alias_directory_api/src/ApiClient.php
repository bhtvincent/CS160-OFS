...
class ApiClient
{
     ...
     */
    public function __construct(\alias_100\Configuration $config = null)
    {
        if ($config === null) {
     ...
     *
     * @throws \alias_100\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($path, $resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers, true)) {
            ...
            $postData = json_encode(\alias_100\ObjectSerializer::sanitizeForSerialization($postData));
        }
