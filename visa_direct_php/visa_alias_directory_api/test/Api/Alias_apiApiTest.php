...
class Alias_apiApiTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testPostCreateAlias()
    {
        ...
        $api_instance = new Alias_apiApi;
        $result = $api_instance->PostCreateAlias($this->transformPayload('{"recipientMiddleName":"M","city":"Nairobi","consentDateTime":"2018-03-01 01:02:03","country":"KE","address2":"Region 1","recipientFirstName":"Jamie","recipientPrimaryAccountNumber":"4895140000066666","alias":"254711333888","cardType":"Visa Classic","aliasType":"01","address1":"Street 1","postalCode":"00111","issuerName":"Test Bank 1","guid":"574f4b6a4c2b70472f306f300099515a789092348832455975343637a4d3170","recipientLastName":"Bakari"}'));
    ...
    public function testPostUpdateAlias()
    {
        ...
        $api_instance = new Alias_apiApi;
        $result = $api_instance->PostUpdateAlias($this->transformPayload('{"city":"Nairobi","recipientFirstName":"Ike ","country":"KEN","newGuid":"updatedsandboxguid123456789","recipientPrimaryAccountNumber":"4855070000000035","alias":"18072123418041","cardType":"Local Visa Classic","aliasType":"01","postalCode":"00101","issuerName":"CO-OPERATIVE BANK","guid":"y0alq2zs6f5rpzluvjrp","recipientLastName":"Njoroge"}'));
